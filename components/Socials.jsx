...
/**
 * @enum {string} 
 * Svg title strings for all supported socials 
 */
const brandTitles = {
  facebook: "Facebook",
  instagram: "Instagram",
...
/**
 * @enum {string} 
 * Svg path strings for all supported socials 
 */
const brandSvgPaths = {
 ...
 * @param {string} params.platformKey - playform key for interfacing with {@link brandColors}, {@link brandTitles}, and {@link brandSvgPaths}
...
function SocialIcon({platformKey, size, color}) {
  ...
  /** Title to be displayed on hover from {@link brandTitles} */
  const brandTitle = brandTitles[platformKey];
  /** SVG fill color from {@link brandColors} */
  const brandColor = brandColors[platformKey];
  /** SVG path for brand logo from {@link brandSvgPaths} */
  ...
  return (
    ...
    >
      ...
      <path fill={color ? color : brandColor} d={svgPath}/>
    </svg>
  );
}
